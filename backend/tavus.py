...
GREETINGS = {
    "en": "Hi! Welcome to All Nassau Dental! I'm Jenny — I can help you check in real quick. What's your name?",
    "es": "¡Hola! ¡Bienvenido a All Nassau Dental! Soy Jenny, puedo ayudarle a registrarse. ¿Cómo se llama?",
    "ru": "Привет! Добро пожаловать в All Nassau Dental! Я Дженни, помогу быстро зарегистрироваться. Как вас зовут?",
}
